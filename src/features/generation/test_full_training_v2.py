...
def test_read_best_metric_returns_total_by_default() -> None:
    from src.features.generation.full_training_v2 import _readBestMetric
...
def test_release_device_memory_no_op_on_cpu() -> None:
    ...
    from src.features.generation.full_training_v2 import _releaseDeviceMemory
...
def test_format_memory_stats_returns_empty_on_cpu() -> None:
    ...
    from src.features.generation.full_training_v2 import _formatMemoryStats
